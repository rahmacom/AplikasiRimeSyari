...
import com.rahmacom.rimesyarifix.ui.home.HomeFragmentDirections;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        NavHostFragment navHostFragment =
                (NavHostFragment) getSupportFragmentManager()
                        .findFragmentById(binding.navHostFragmentActivityMain.getId());
...
//        navController = Navigation.findNavController(binding.getRoot());
        ...
        navController.addOnDestinationChangedListener((controller, destination, arguments) -> {
            if (destination.getId() == R.id.nav_profil
                    || destination.getId() == R.id.nav_home
                    || destination.getId() == R.id.nav_order) {

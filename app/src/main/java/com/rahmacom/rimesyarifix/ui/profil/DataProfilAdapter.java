...
import com.rahmacom.rimesyarifix.databinding.ItemProfilListBinding;
...
public class DataProfilAdapter extends RecyclerView.Adapter<DataProfilAdapter.ViewHolder> {
    ...
    private ItemProfilListBinding binding;
    ...
    public DataProfilAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        binding = ItemProfilListBinding.inflate(LayoutInflater.from(parent.getContext()), parent, false);
    ...
    static class ViewHolder extends RecyclerView.ViewHolder {
        private final ItemProfilListBinding binding;

        ViewHolder(@NonNull ItemProfilListBinding binding) {

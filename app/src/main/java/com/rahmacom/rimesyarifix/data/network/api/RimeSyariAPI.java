...
public interface RimeSyariAPI {
    ...
    Call<LoginResponse> updateLogin(@Header("Authorization") String token, @Field("email") String email, @Field("old_password") String oldPassword, @Field("new_password") String newPassword);
    ...
    @FormUrlEncoded
    @Headers({"Accept: application/json"})
    Call<User> updateProfile(@Header("Authorization") String token, @Field("name") String name, @Field("jenis_kelamin") String jenisKelamin, @Field("tempat_lahir") String tempatLahir, @Field("tgl_lahir") String tglLahir, @Field("alamat") String alamat, @Field("shipment_id") int shipmentId, @Field("no_hp") String noHP, @Field("no_wa") String noWA);
